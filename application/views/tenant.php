...
<body onload="hideloader()">
	<div id="loading">
		...
		<div>
			<nav class="navbar navbar-default navbar-fixed-top wow animated flipInX data-wow-duration='0,1s' data-wow-delay='0,1s'">
				<div class="container">
			...
			<br>
			<div class="container container-tenant">
				<div class="row">
					<div class="col-md-12">
						<p class="border" style="margin-top: 40px; margin-left: 40px;"><strong>Menjadi Tenant</strong></p>
						<p style="padding: 40px; margin-bottom: 10px; ">Plasapedia menjalin kerjasama dengan para tenant agar dapat menunjang proses penjualan dari berbagai tenant. Adapun persyaratan Tenant yang harus dipenuhi adalah sebagai berikut:</p>
						<p style="margin-left:35px;  margin-top: 10px; color: #20a1ae; text-align: left; font-size: 25px;"><strong>Persyaratan Menjadi Tenant</strong></p>
						<ol style="list-style-type: none;">
							<?php foreach ($data_tenant as $key) { ?>
							<li style="margin-left:10px; margin-bottom: 20px;"><?php echo $key['isi_tenant']; ?></li>
							<?php } ?>
						</ol>
					</div>
				</div>
